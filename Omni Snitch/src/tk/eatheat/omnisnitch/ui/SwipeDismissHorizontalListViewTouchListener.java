 ...
 * {@link SwipeDismissHorizontalListViewTouchListener} is paused during list
 * view scrolling.
 * </p>
 * 
 * <p>
...
public class SwipeDismissHorizontalListViewTouchListener implements
     ...
     * {@link SwipeDismissHorizontalListViewTouchListener} to inform its client
    ...
    public interface DismissCallbacks {
         ...
         */
        void onDismiss(HorizontalListView listView, int[] reverseSortedPositions);
    }
     ...
     */
    public SwipeDismissHorizontalListViewTouchListener(
            HorizontalListView listView, DismissCallbacks callbacks) {
     ...
     * view scrolling.</p>
     * 
     * @see SwipeDismissHorizontalListViewTouchListener
     */
    ...
    private void dismiss(final View view, final int position, boolean dismissUp) {
        ...
        view.animate().translationY(dismissUp ? -mViewHeight : mViewHeight)
