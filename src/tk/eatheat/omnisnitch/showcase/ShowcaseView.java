...
package tk.eatheat.omnisnitch.showcase;
...
public class ShowcaseView extends RelativeLayout implements
    ...
    public ShowcaseView(Context context, AttributeSet attrs, int defStyle) {
        ...
        titleTextColor = styled.getColor(
                R.styleable.ShowcaseView_sv_titleTextColor,
    ...
    private float[] getBestTextPosition(int canvasW, int canvasH) {
        ...
        return new float[] {
                24 * metricScale,
                spaceTop > spaceBottom ? 128 * metricScale : 24 * metricScale
                        + voidedArea.bottom, canvasW - 48 * metricScale };
    }
    ...
    private boolean makeVoidedRect() {
        ...
        if (voidedArea == null
                || (showcaseX != legacyShowcaseX || showcaseY != legacyShowcaseY)) {
